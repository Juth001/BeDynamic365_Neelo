...
table 82107 "BeDyn Pleo Category Map"
{
    Caption = 'Mapeo Categorías Pleo';
    DataClassification = CustomerContent;
    LookupPageId = "BeDyn Pleo Category Map";
    DrillDownPageId = "BeDyn Pleo Category Map";

    // Sustituye al mapeo de tipos de gasto (tabla 82103, obsoleta): desde el export
    // de julio de 2026 Pleo ya no incluye las columnas "Tipo Gasto - Name/Code"
    // (campo personalizado) y la categoría estándar (columna "Category") asume su
    // papel. Clave = nombre exacto de la categoría, igual que el mapeo de
    // compradores usa el nombre del empleado. Determina la cuenta de gasto o el
    // tratamiento CAPEX (clase/subclase del activo) y la tarea de proyecto.
    ...
    fields
    {
        ...
        field(5; "FA Subclass Code"; Code[10])
        {
