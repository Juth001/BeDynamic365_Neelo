...
page 82519 "BeDyn Property Picture"
{
    PageType = CardPart;
    ...
    layout
    {
        area(Content)
        {
            field(Picture; Rec.Picture)
            {
                ApplicationArea = All;
                ShowCaption = false;
                ToolTip = 'Imagen de la propiedad.';
            }
        }
    }
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(DeletePicture)
            {
                ...
                Image = Delete;
                Enabled = HasPicture;
                ToolTip = 'Elimina la imagen de la propiedad.';
    ...
    begin
        ...
        FileName := Rec."No." + GetExtension(TenantMedia."Mime Type");
    ...
    var
        ...
        OverrideImageQst: Label 'La propiedad ya tiene una imagen. ¿Desea reemplazarla?';
